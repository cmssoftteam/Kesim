TYPE
	...
	McPathGenMonElemToolIdentType : STRUCT (*Monitoring Element: Tool identifier*)
	...
	McPathGenMonElemDynamicDecType : STRUCT (*Monitoring Element: Dynamic decelerations*)
		Decelerations : ARRAY [0..14] OF LREAL; (**)
	END_STRUCT;

	McPathGenMonElemSkipLevelType : STRUCT (*Monitoring Element: Skip block level*)
